...
export const products: Product[] = [
  {
    ...
    shortBenefits:
      "Gentle silicone cleansing, easy handling, and a more polished daily skincare routine.",
    benefits: [
  ...
  },
  {
    ...
    shortBenefits:
      "Lightweight comfort, smoother overnight wear, and a cleaner post-shower routine.",
    benefits: [
  ...
  },
  {
    ...
    shortBenefits:
      "Adjustable lighting, cleaner visibility, and a vanity-friendly premium look.",
    benefits: [
  ...
  },
  {
    ...
    shortBenefits:
      "Compact multi-device charging, less cable clutter, and a cleaner desk setup.",
    benefits: [
  ...
  },
  {
    ...
    shortBenefits:
      "Longer warm-drink comfort, premium design, and a workday-friendly feel.",
    benefits: [
  ...
  },
  {
    ...
    shortBenefits:
      "Portable viewing, relaxed setup, and a space-saving entertainment option.",
    benefits: [
